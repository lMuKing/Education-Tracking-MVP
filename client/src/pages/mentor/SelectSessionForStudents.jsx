...
const SelectSessionForStudents = () => {
    ...
    <div className="min-h-screen bg-gradient-to-br from-cyan-900 via-blue-900 to-blue-700 p-4 md:p-8 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto pt-16 md:pt-8">
        <div className="text-center mb-8">
          ...
          <p className="text-blue-200">Choose a session to view enrolled students</p>
        </div>
        ...
        {sessions.length === 0 ? (
          ...
          <div className="space-y-4">
            {sessions.map((session) => (
              <a
                key={session.id}
                href={`/mentor/session-students/${session.id}`}
                className="block bg-white rounded-2xl shadow-xl p-4 md:p-6 border border-gray-100 hover:shadow-2xl hover:border-green-300 transition"
              >
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex flex-wrap gap-4 text-xs md:text-sm text-gray-600">
                      <div className="flex items-center gap-1">
                        ...
                        <span>{session.current_enrolled_count || 0} / {session.max_students} students enrolled</span>
                      </div>
                      {session.createdAt && (
                        <div className="flex items-center gap-1">
...
export default SelectSessionForStudents;
